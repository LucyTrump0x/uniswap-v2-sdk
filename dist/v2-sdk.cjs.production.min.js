...
var E = 'setPrototypeOf' in Object,
  ...
  R = (function() {
    ...
    t.getAddress = function(t, e) {
      var r,
        n = null != (r = s[t.chainId]) ? r : '0x90Ea7fA7aaE75F92eB6D493f4ECF995357C0167d'
      return _({ factoryAddress: n, tokenA: t, tokenB: e })
    }
    var n = t.prototype
    return (
      ...
      (n.getOutputAmount = function(n, u) {
        ...
        if (r.equal(v.quotient, p)) throw new F()
        ...
        if (r.equal(T.quotient, p)) throw new F()
      ...
      (n.getLiquidityMinted = function(t, n, u) {
        ...
        if (!r.greaterThan(o, p)) throw new F()
