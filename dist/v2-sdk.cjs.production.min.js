...
var E = 'setPrototypeOf' in Object,
  ...
  R = (function() {
    ...
    t.getAddress = function(t, e) {
      var r,
        n = null != (r = s[t.chainId]) ? r : '0xd1E3b8f35fbaA87dDb69b1C3bD1Fadb7af7a8Baa'
    ...
    return (
      ...
      (n.getOutputAmount = function(n, u) {
        ...
        var o = this.reserveOf(n.currency),
          ...
          l = r.multiply(c.quotient, d),
          m = r.multiply(l, s.quotient),
          f = r.add(r.multiply(o.quotient, h), l),
      ...
      (n.getInputAmount = function(n, u) {
        ...
        var a = this.reserveOf(n.currency),
          ...
          m = r.multiply(r.multiply(c.quotient, s.quotient), h),
          f = r.multiply(r.subtract(a.quotient, s.quotient), d),
        ...
        if (
          ...
          if (r.equal(c, p)) a = n
            ...
            var l = e.sqrt(r.multiply(this.reserve0.quotient, this.reserve1.quotient)),
              d = e.sqrt(c)
            if (r.greaterThan(l, d)) {
              var h = r.multiply(n.quotient, r.subtract(l, d)),
                f = r.add(r.multiply(l, m), d),
                y = r.divide(h, f)
      ...
      for (var y = a.wrapped, v = u.wrapped, A = 0; A < r.length; A++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            e.sortedInsert(c, new t(new B([].concat(s, [T]), n.currency, u), n, e.TradeType.EXACT_INPUT), d, j)
          else if (f > 1 && r.length > 1) {
            var k = r.slice(0, A).concat(r.slice(A + 1, r.length))
            t.bestTradeExactIn(k, n, u, { maxNumResults: d, maxHops: f - 1 }, [].concat(s, [T]), q, c)
          }
        }
      }
      return c
    ...
    (t.bestTradeExactOut = function(r, n, u, o, s, a, c) {
      ...
      for (var y = a.wrapped, v = n.wrapped, A = 0; A < r.length; A++) {
        ...
        if (
          ...
          if (q.currency.equals(v))
            e.sortedInsert(c, new t(new B([T].concat(s), n, u.currency), u, e.TradeType.EXACT_OUTPUT), d, j)
          else if (f > 1 && r.length > 1) {
            var k = r.slice(0, A).concat(r.slice(A + 1, r.length))
            t.bestTradeExactOut(k, n, u, { maxNumResults: d, maxHops: f - 1 }, [T].concat(s), q, c)
          }
        }
      }
      return c
    ...
    (t.swapCallParameters = function(t, r) {
      ...
      switch (t.tradeType) {
        ...
        case e.TradeType.EXACT_OUTPUT:
          h && i(!1),
            n
              ? ((o = 'swapETHForExactTokens'), (s = [l, m, c, d]), (a = p))
              : u
              ? ((o = 'swapTokensForExactETH'), (s = [l, p, m, c, d]), (a = '0x0'))
              : ((o = 'swapTokensForExactTokens'), (s = [l, p, m, c, d]), (a = '0x0'))
      }
