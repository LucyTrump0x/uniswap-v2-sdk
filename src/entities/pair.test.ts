...
describe('computePairAddress', () => {
  it('should correctly compute the pool address', () => {
    const tokenA = new Token(1, '0x473e861f4E87DF6aaE53a3A6f4146F24Ac2D7A80', 18, 'USDT', 'USD Coin')
    const tokenB = new Token(1, '0x8Dd1F11c6D54f80E5F91564256A9886C35C54a43', 18, 'DAI', 'DAI Stablecoin')
    const result = computePairAddress({
      factoryAddress: '0x3B080860Bb2eE6349F6cDA88E24C47213A16634E',
      tokenA,
      tokenB
    })

    expect(result.toUpperCase()).toEqual(`0x294ff72a1071770112cb008f55c8814c44b5f806`.toUpperCase())
  })
